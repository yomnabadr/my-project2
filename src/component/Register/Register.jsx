...
export default function Register() {
  ...
  let  validationSchema = Yup.object().shape({
    ...
    rePassword : Yup.string().oneOf([Yup.ref('password')]  , 'password and repasswoord dont match').required('pass is required'),
    phone : Yup.string().min(3).max(11).required('phone is required'),
  })
...
let formik = useFormik({
 ...
 <div className='w-1/2 mx-auto py-6'>
  ...
  <div className="relative z-0 w-full mb-5 group">
      <input type="pass" name="rePassword" id="rePassword" value={formik.values.rePassword} onChange={formik.handleChange} onBlur={formik.handleBlur} className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder="  " />
